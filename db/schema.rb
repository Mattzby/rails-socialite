...
ActiveRecord::Schema.define(version: 20180228151152) do
  ...
  create_table "rsvps", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "event_id"
    t.bigint "user_id"
    t.integer "rsvp_status", limit: 1
